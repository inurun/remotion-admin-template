...
export function withoutStaleDictionaryWords(
  ...
  // Incoming dictionary_words belong to this item's text/kana. Drop them only when
  // the same words were copied from a previous snapshot onto a different pair.
